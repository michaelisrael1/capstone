...
(1,'Alice','Johnson','Student','ACTIVE','Student','Central High',NULL,'2024-08-01',NULL,TRUE,'Good academic standing'),
(2,'Bob','Smith','Staff','ACTIVE','Coordinator',NULL,'Case Management','2022-01-10',NULL,TRUE,'Senior coordinator'),
(3,'Charlie','Brown','Client','ACTIVE','Client',NULL,NULL,'2023-05-01',NULL,FALSE,'Requires support services'),
(4,'Diana','Miller','Staff','ACTIVE','Admin',NULL,'Administration','2020-03-15',NULL,TRUE,'System administrator'),
(5,'Ethan','Davis','Student','ACTIVE','Student','West High',NULL,'2025-01-10',NULL,TRUE,'New transfer student'),
(6,'Fiona','Garcia','Client','INACTIVE','Client',NULL,NULL,'2021-09-01','2024-09-01',FALSE,'Completed program'),
(7,'George','Wilson','Staff','ACTIVE','Coordinator',NULL,'Case Management','2019-06-20',NULL,TRUE,'Field coordinator'),
(8,'Hannah','Moore','Staff','ACTIVE','Coordinator',NULL,'Case Management','2021-11-05',NULL,TRUE,'New coordinator');
